...
for(run in c("a","b","c")){
  xlimz = c(-2.2,2.2)
  title_pos = -2.2
  pdf(file = paste0("Plots/Paper_Plot_4_Variance_2_histo_xnap",run,".pdf"), width = 1.3*6, height = 2*PLOTTING_VARIABLES$HEIGHT/1.5)
  ...
  text(-1.4, 0.6, "full", col = "black", cex = 1.5)
