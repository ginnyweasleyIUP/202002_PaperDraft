...
coastline_map <- rgdal::readOGR(dsn ="~/07_R_Code/naturalearth_10m_physical/ne_10m_coastline.shp", verbose = FALSE)
karst_map <- rgdal::readOGR(dsn = "~/07_R_Code/202001_PaperDraft/Karst/karst_wgs.shp", verbose = FALSE)
