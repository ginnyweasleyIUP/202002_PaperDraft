...
### plot age uncertainties as interquartile ranges
...
### plot existing isotope measurements
...
### plot dating information for detrital control -> corrected ages shoould be smaller than uncorrected ages
...
### final plot function
final.plot<- function(eID,  ### vector of entity_id's for which plots are to be executed, i.e. c(1,2,3,4)
                      fp_input, #### file path to sisal files, i.e. '~/SISAL_Data/sisalv2_20200130/'
                      fp_output){ ### file path to folder where plots are to be saved, i.e. '~/SISAL_Data/plots/'
  eId <- eID
...
#final.plot(c(14), "/stacywork/ginnyweasley/02_SISAL/SISAL_v2/", "blabla")
