...
ANALYSIS$CORR$FIELD <- list("a" = list(), "b" = list(),"c" = list())
for(run in c("a","b","c")){
  ANALYSIS$CORR$FIELD[[run]]$CORR_TEMP_ISOT = array(dim = c(96,73))
  ANALYSIS$CORR$FIELD[[run]]$CORR_TEMP_ISOT_P = array(dim = c(96,73))
  ANALYSIS$CORR$FIELD[[run]]$CORR_PREC_ISOT = array(dim = c(96,73))
  ANALYSIS$CORR$FIELD[[run]]$CORR_PREC_ISOT_P = array(dim = c(96,73))
