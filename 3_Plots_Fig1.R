...
Timeseries$HadCM3_GMST_a <- zoo(x = value$a-mean(value$a), order.by = seq(from = -1*(1950- DATA_past1000$time[1]), to = -1*(1950 - DATA_past1000$time[2]), by = 1))
Timeseries$HadCM3_GMST_b <- zoo(x = value$b-mean(value$b), order.by = seq(from = -1*(1950- DATA_past1000$time[1]), to = -1*(1950 - DATA_past1000$time[2]), by = 1))
Timeseries$HadCM3_GMST_c <- zoo(x = value$c-mean(value$c), order.by = seq(from = -1*(1950- DATA_past1000$time[1]), to = -1*(1950 - DATA_past1000$time[2]), by = 1))
...
mtext(side=2,expression(paste(plain(HadCM3)," ",plain(a))),cex=namcex,line=namlin,las=1,col=col_hadcm3_temp, at = .7)
...
mtext(side=4,expression(paste(plain(HadCM3)," ",plain(a))),cex=namcex,col=col_hadcm3_d18O,las=1, line = 5, at = -7)
